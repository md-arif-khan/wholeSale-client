        ...
        <div class="grid grid-cols-1 md:items-stretch md:grid-cols-2 gap-x-12 lg:gap-x-20 gap-y-10">
            <div class="flex flex-col justify-between lg:py-5">
                <div>
                    ...
                    <p class="max-w-xl mx-auto mt-4 text-base leading-relaxed text-white">A contact form is a short web-based form published on a website. Any visitor can fill out the form and submit it to send a message to the site owner. Behind the scenes, your contact form triggers an email message to be generated and sent to your email inbox.</p>
            ...
            <div class="lg:pl-12">
                <div class="overflow-hidden bg-white rounded-md">
                    <div class="p-6 sm:p-10">
                        ...
                        <p class="mt-4 text-base text-gray-600">Some ideas for what you can say instead of 'Contact Us' include: Drop Us a Line. Get in Touch. Reach Out.</p>
